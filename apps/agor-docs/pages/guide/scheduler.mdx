...
![Configure schedule modal showing cron builder, agent selection, and prompt template inputs](/screenshots/configure_schedule.png)
...
4. **Configure the agent.**
   - Pick the agentic tool (Claude Code, Cursor, Codex, Gemini) that will own the run.
